...
public class MessageController {
    ...
    @PostMapping("/send")
    public ResponseEntity<MessageInteractionDTO> sendMessage(@RequestBody @Valid SendMessageDTO dto){
        MessageInteractionDTO interaction = messageService.sendMessage(dto);
